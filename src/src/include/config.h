...
#define TOKENS_RE         ";|<-|\\+\\+|--|\\*\\*|,|Eq|Neq|:|\\(|\\)|Ls|Gr|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|<-|\\+\\+|--|\\*\\*|,|Eq|Neq|:|\\(|\\)|StartProgram|Variable|StartBlok|EndBlok|Exit|Continue|Scan|Print|If|else|For|To|Downto|Do|While|Repeat|Until|Goto|Div|Mod|<=|>=|Not|And|Or|Int32"
#define IDENTIFIERS_RE    "_[a-z]"
...
//
#define T_BEGIN_0 "StartBlok"
#define T_BEGIN_1 ""
#define T_BEGIN_2 ""
#define T_BEGIN_3 ""
#define T_END_0 "EndBlok"
#define T_END_1 ""
#define T_END_2 ""
#define T_END_3 ""
//
